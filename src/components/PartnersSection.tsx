    ...
    <section id="partnerzy" className="py-20 bg-gray-50">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16 animate-fade-in">
          <h2 className="text-xl md:text-2xl font-bold mb-4 transition-all duration-500">Nasi Partnerzy</h2>
              ...
              <div className="mt-auto">
                {partner.fullDescription ? (
                  <div className="text-center">
                    ...
                    >
                      Zobacz więcej
                      <ChevronRight size={12} className="ml-1 transition-transform duration-300" />
                    </Link>
                  </div>
                ) : (
